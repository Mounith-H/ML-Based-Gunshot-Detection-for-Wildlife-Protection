...
const char* ei_classifier_inferencing_categories[] = { "ESC", "gunshot" };
...
ei_dsp_config_mfcc_t ei_dsp_config_2 = {
    ...
    13, // int num_cepstral
    0.1f, // float frame_length
    0.1f, // float frame_stride
    32, // int num_filters
    256, // int fft_length
    101, // int win_size
    0, // int low_frequency
...
const ei_impulse_t impulse_744131_0 = {
    .project_id = 744131,
    .project_owner = "Mounith",
    .project_name = "ml_pico",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_744131_0 = ei_impulse_handle_t( &impulse_744131_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_744131_0;
